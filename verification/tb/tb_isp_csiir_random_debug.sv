...
module tb_isp_csiir_random;
    ...
    always @(posedge clk) begin
        if (dut.u_line_buffer.window_valid && lb_out_cnt < 10) begin
            ...
            $display("  wr_col_ptr=%0d output_center=%0d row_cnt=%0d img_width=%0d",
                dut.u_line_buffer.wr_col_ptr, dut.u_line_buffer.output_center,
                dut.u_line_buffer.row_cnt, dut.u_line_buffer.img_width);
        end
    end
...
// Track Stage 2 window input
integer s2_win_cnt;
initial s2_win_cnt = 0;
always @(posedge clk) begin
    if (dut.s1_valid && s2_win_cnt < 3) begin
        s2_win_cnt = s2_win_cnt + 1;
        $display("[S2 WIN %0d] win(0,0)=%0d win(0,4)=%0d win(2,2)=%0d win(4,0)=%0d win(4,4)=%0d px=%0d py=%0d",
            s2_win_cnt, dut.s1_win_0_0, dut.s1_win_0_4, dut.s1_win_2_2,
            dut.s1_win_4_0, dut.s1_win_4_4, dut.s1_pixel_x, dut.s1_pixel_y);
        $display("  win_row0: %0d %0d %0d %0d %0d",
            dut.s1_win_0_0, dut.s1_win_0_1, dut.s1_win_0_2, dut.s1_win_0_3, dut.s1_win_0_4);
        $display("  win_row1: %0d %0d %0d %0d %0d",
            dut.s1_win_1_0, dut.s1_win_1_1, dut.s1_win_1_2, dut.s1_win_1_3, dut.s1_win_1_4);
        $display("  win_row2: %0d %0d %0d %0d %0d",
            dut.s1_win_2_0, dut.s1_win_2_1, dut.s1_win_2_2, dut.s1_win_2_3, dut.s1_win_2_4);
        $display("  win_row3: %0d %0d %0d %0d %0d",
            dut.s1_win_3_0, dut.s1_win_3_1, dut.s1_win_3_2, dut.s1_win_3_3, dut.s1_win_3_4);
        $display("  win_row4: %0d %0d %0d %0d %0d",
            dut.s1_win_4_0, dut.s1_win_4_1, dut.s1_win_4_2, dut.s1_win_4_3, dut.s1_win_4_4);
    end
end
